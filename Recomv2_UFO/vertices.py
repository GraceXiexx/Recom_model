...
V_76 = Vertex(name = 'V_76',
              particles = [ P.Gp, P.Th, P.Th ],
              color = [ 'f(1,2,3)' ],
              lorentz = [ L.VSS1 ],
              couplings = {(0,0):C.GC_31})

V_77 = Vertex(name = 'V_77',
              particles = [ P.G, P.Th, P.Th ],
              color = [ 'f(1,2,3)' ],
              lorentz = [ L.VSS1 ],
              couplings = {(0,0):C.GC_6})

V_78 = Vertex(name = 'V_78',
              particles = [ P.G, P.G, P.Th, P.Th ],
              color = [ 'f(-1,1,3)*f(2,4,-1)', 'f(-1,1,4)*f(2,3,-1)' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(1,0):C.GC_7,(0,0):C.GC_7})

V_79 = Vertex(name = 'V_79',
              particles = [ P.G, P.Gp, P.Th, P.Th ],
              color = [ 'f(-1,1,3)*f(2,4,-1)', 'f(-1,1,4)*f(2,3,-1)' ],
              lorentz = [ L.VVSS1 ],
              couplings = {(1,0):C.GC_33,(0,0):C.GC_33})

V_80 = Vertex(name = 'V_80',
              particles = [ P.G, P.Gp, P.Ph, P.Th ],
              color = [ 'f(1,2,4)' ],
              lorentz = [ L.VVSS1 ],
